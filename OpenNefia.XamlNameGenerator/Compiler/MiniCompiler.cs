...
{
    public const string OpenNefiaXmlnsDefinitionAttribute = "Avalonia.Metadata.XmlnsDefinitionAttribute";
    ...
    protected override XamlEmitContext<object, IXamlEmitResult> InitCodeGen(
        ...
        Func<string, IXamlType, IEnumerable<IXamlType>, IXamlTypeBuilder<object>> createDelegateType,
