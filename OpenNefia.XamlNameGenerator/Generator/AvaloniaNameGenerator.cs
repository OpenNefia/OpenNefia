...
internal class OpenNefiaNameGenerator : INameGenerator
{
    ...
    public IReadOnlyList<GeneratedPartialClass> GenerateNameReferences(IEnumerable<AdditionalText> additionalFiles)
    {
        ...
        var query =
            ...
            let code = _code.GenerateCode(view.ClassName, view.Generics, view.Namespace, view.XamlType, names)
