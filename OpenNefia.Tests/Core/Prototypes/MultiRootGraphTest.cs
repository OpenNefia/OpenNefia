...
namespace OpenNefia.Tests.Core.Prototypes
{
    ...
    public sealed class MultiRootGraphTest
    {
        ...
        public void AddAndRemoveRoot()
        {
            ...
            graph.Add(Id1);
            Assert.That(graph.RootNodes.Count, NUnit.Framework.Is.EqualTo(1));
        ...
        public void AddAndRemoveRootAndChild()
        {
            ...
            Assert.That(children, NUnit.Framework.Is.Not.Null);
            Assert.That(children!.Count, NUnit.Framework.Is.EqualTo(1));
            Assert.That(children.Contains(Id3));

            var parents = graph.GetParents(Id3);
            Assert.That(parents, NUnit.Framework.Is.Not.Null);
            Assert.That(parents!.Count, NUnit.Framework.Is.EqualTo(1));
        ...
        public void AddTwoParentsRemoveOne()
        {
            ...
            var parents = graph.GetParents(Id3);
            Assert.That(parents, NUnit.Framework.Is.Not.Null);
            Assert.That(parents!.Count, NUnit.Framework.Is.EqualTo(2));
            Assert.That(parents!.Contains(Id1));
            ...
            Assert.That(graph.RootNodes.Count, NUnit.Framework.Is.EqualTo(2));
            Assert.That(graph.RootNodes.Contains(Id1));
        ...
        public void OneParentTwoChildrenRemoveParent()
        {
            ...
            var children = graph.GetChildren(Id1);
            Assert.That(children, NUnit.Framework.Is.Not.Null);
            Assert.That(children!.Count, NUnit.Framework.Is.EqualTo(2));
            Assert.That(children.Contains(Id3));
