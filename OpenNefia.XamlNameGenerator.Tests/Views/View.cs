...
using OpenNefia.Controls;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;

namespace OpenNefia.NameGenerator.Tests.Views;
...
public static class View
{
    ...
    public static CSharpCompilation CreateOpenNefiaCompilation(string excludedPattern = null)
    {
        var compilation = CSharpCompilation
            .Create("OpenNefiaLib", options: new CSharpCompilationOptions(OutputKind.DynamicallyLinkedLibrary))
