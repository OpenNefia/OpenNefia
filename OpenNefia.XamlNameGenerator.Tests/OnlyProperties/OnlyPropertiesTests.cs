...
namespace OpenNefia.NameGenerator.Tests.OnlyProperties;
...
public class OnlyPropertiesTests
{
    ...
    public async Task Should_Generate_FindControl_Refs_From_OpenNefia_Markup_File(string expectation, string markup)
    {
        var compilation =
            View.CreateOpenNefiaCompilation()
                .WithCustomTextBox();
