...
using OpenNefia.NameGenerator.Compiler;
using OpenNefia.NameGenerator.Generator;
using OpenNefia.NameGenerator.Tests.InitializeComponent.GeneratedInitializeComponent;
using OpenNefia.NameGenerator.Tests.OnlyProperties.GeneratedCode;
using OpenNefia.NameGenerator.Tests.Views;
using Microsoft.CodeAnalysis.CSharp;
using Xunit;

namespace OpenNefia.NameGenerator.Tests.InitializeComponent;
...
public class InitializeComponentTests
{
    ...
    public async Task Should_Generate_FindControl_Refs_From_OpenNefia_Markup_File(
        string expectation,
        string markup,
        bool devToolsMode)
    {
        var excluded = devToolsMode ? null : "OpenNefia.Diagnostics";
        var compilation =
            View.CreateOpenNefiaCompilation(excluded)
                .WithCustomTextBox();
        ...
        var classResolver = new XamlXViewResolver(
            ...
            MiniCompiler.CreateDefault(
                ...
                MiniCompiler.OpenNefiaXmlnsDefinitionAttribute));
