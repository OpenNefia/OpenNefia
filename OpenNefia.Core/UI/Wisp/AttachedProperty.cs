namespace OpenNefia.Core.UI.Wisp
{
    ...
    public delegate void AttachedPropertyChangedCallback(WispControl owner, AttachedPropertyChangedEventArgs eventArgs);

    public delegate void AttachedPropertyChangedCallback<T>(WispControl owner,
