...
namespace OpenNefia.Core.UI.Wisp
{
    ...
    public partial class WispControl
    {
        ...
        internal void Restyle()
        {
            ...
            WispManager.QueueStyleUpdate(this);
        }
        ...
        internal void DoStyleUpdate()
        {
            ...
            {
                _actualStylesheetCached = WispManager.Stylesheet;

                for (var p = this; p != null; p = p.WispParent)
                {
            ...
            for (var type = GetType(); type != typeof(WispControl); type = type!.BaseType)
            {
        ...
        {
            private readonly WispControl _owner;

            public StyleClassCollection(WispControl owner)
            {
                _owner = owner;
            }
