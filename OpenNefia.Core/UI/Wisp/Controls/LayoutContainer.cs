...
namespace OpenNefia.Core.UI.Wisp.Controls
{
    ...
    public class LayoutContainer : Container
    {
        ...
        public static void SetMarginLeft(WispControl control, float value)
        {
            control.SetValue(MarginLeftProperty, value);
        }

        public static void SetMarginTop(WispControl control, float value)
        {
            control.SetValue(MarginTopProperty, value);
        }

        public static void SetMarginRight(WispControl control, float value)
        {
            control.SetValue(MarginRightProperty, value);
        }

        public static void SetMarginBottom(WispControl control, float value)
        {
            control.SetValue(MarginBottomProperty, value);
        }

        public static void SetAnchorLeft(WispControl control, float value)
        {
            control.SetValue(AnchorLeftProperty, value);
        }

        public static void SetAnchorTop(WispControl control, float value)
        {
            control.SetValue(AnchorTopProperty, value);
        }

        public static void SetAnchorRight(WispControl control, float value)
        {
            control.SetValue(AnchorRightProperty, value);
        }

        public static void SetAnchorBottom(WispControl control, float value)
        {
            control.SetValue(AnchorBottomProperty, value);
        }

        public static void SetGrowHorizontal(WispControl control, GrowDirection value)
        {
            control.SetValue(GrowHorizontalProperty, value);
        }

        public static void SetGrowVertical(WispControl control, GrowDirection value)
        {
            control.SetValue(GrowVerticalProperty, value);
        }

        public static void SetPosition(WispControl control, Vector2 position)
        {
        ...
        /// </remarks>
        public static void SetAnchorAndMarginPreset(WispControl control, LayoutPreset preset,
        ...
        /// </exception>
        public static void SetAnchorPreset(WispControl control, LayoutPreset preset, bool keepMargin = false)
        {
        ...
        public static void SetMarginsPreset(WispControl control, LayoutPreset preset,
        ...
        private static UIBox2 CalcAnchorMargins(Vector2 ourSize, float uiScale, WispControl child)
        {
        ...
        private static UIBox2 CalcChildRect(Vector2 ourSize, float uiScale, WispControl child, out UIBox2 anchorSize)
        {
        ...
        private static void LayoutPropertyChangedCallback(WispControl owner, AttachedPropertyChangedEventArgs eventArgs)
        {
        ...
        /// <summary>
        ///     Controls how the control should move when its wanted size (WispControlled by anchors/margins) is smaller
