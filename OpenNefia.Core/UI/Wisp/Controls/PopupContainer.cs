...
namespace OpenNefia.Core.UI.Wisp.Controls
{
    ...
    /// </summary>
    public sealed class PopupContainer : WispControl
    {
        /// <summary>
        ...
        public static void SetPopupOrigin(WispControl control, Vector2 origin)
        {
            control.SetValue(PopupOriginProperty, origin);
        }

        public static Vector2 GetPopupOrigin(WispControl control)
        {
            return control.GetValue<Vector2>(PopupOriginProperty);
        }

        public static Vector2? GetAltOrigin(WispControl control)
        {
            return control.GetValue<Vector2?>(AltOriginProperty);
        }

        public static void SetAltOrigin(WispControl control, Vector2? origin)
        {
            control.SetValue(AltOriginProperty, origin);
        }

        private static void PopupOriginChangedCallback(WispControl owner, AttachedPropertyChangedEventArgs eventArgs)
        {
