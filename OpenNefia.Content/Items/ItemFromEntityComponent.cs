...
{
    /// <summary>
    /// Indicates this item originated from some other entity that had
    /// a prototype ID attached. Examples include milk and corpses.
    /// </summary>
    [RegisterComponent]
    [ComponentUsage(ComponentTarget.Normal)]
    public sealed class ItemFromEntityComponent : Component
    {
        public override string Name => "ItemFromEntity";
