...
namespace OpenNefia.Content.Prototypes
{
    public static partial class Protos
    {
        public static class Skill
        {
            ...
            public static readonly SkillPrototypeId EffectEvolution            = new($"Elona.{nameof(EffectEvolution)}");
            ...
            public static readonly SkillPrototypeId BuffHolyShield      = new($"Elona.{nameof(BuffHolyShield)}");
            public static readonly SkillPrototypeId BuffMistOfSilence   = new($"Elona.{nameof(BuffMistOfSilence)}");
            public static readonly SkillPrototypeId BuffRegeneration    = new($"Elona.{nameof(BuffRegeneration)}");
            public static readonly SkillPrototypeId BuffElementalShield = new($"Elona.{nameof(BuffElementalShield)}");
            public static readonly SkillPrototypeId BuffSpeed           = new($"Elona.{nameof(BuffSpeed)}");
            public static readonly SkillPrototypeId BuffSlow            = new($"Elona.{nameof(BuffSlow)}");
            public static readonly SkillPrototypeId BuffHero            = new($"Elona.{nameof(BuffHero)}");
            public static readonly SkillPrototypeId BuffMistOfFrailness = new($"Elona.{nameof(BuffMistOfFrailness)}");
            public static readonly SkillPrototypeId BuffElementScar     = new($"Elona.{nameof(BuffElementScar)}");
            public static readonly SkillPrototypeId BuffHolyVeil        = new($"Elona.{nameof(BuffHolyVeil)}");
            public static readonly SkillPrototypeId BuffNightmare       = new($"Elona.{nameof(BuffNightmare)}");
            public static readonly SkillPrototypeId BuffDivineWisdom    = new($"Elona.{nameof(BuffDivineWisdom)}");
            public static readonly SkillPrototypeId BuffPunishment      = new($"Elona.{nameof(BuffPunishment)}");
            public static readonly SkillPrototypeId BuffLulwysTrick     = new($"Elona.{nameof(BuffLulwysTrick)}");
            public static readonly SkillPrototypeId BuffIncognito       = new($"Elona.{nameof(BuffIncognito)}");
            public static readonly SkillPrototypeId BuffDeathWord       = new($"Elona.{nameof(BuffDeathWord)}");
            public static readonly SkillPrototypeId BuffBoost           = new($"Elona.{nameof(BuffBoost)}");
            public static readonly SkillPrototypeId BuffContingency     = new($"Elona.{nameof(BuffContingency)}");
