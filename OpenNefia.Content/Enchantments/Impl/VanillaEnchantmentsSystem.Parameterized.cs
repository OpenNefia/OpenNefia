...
namespace OpenNefia.Content.Enchantments
{
    ...
    {
        private void Initialize_Parameterized()
        {
            ...
            SubscribeComponent<EncModifyAttributeComponent, ApplyEnchantmentOnRefreshEvent>(EncModifyAttribute_Apply);
            ...
            SubscribeComponent<EncModifyResistanceComponent, ApplyEnchantmentOnRefreshEvent>(EncModifyResistance_Apply);
            SubscribeComponent<EncModifyResistanceComponent, ApplyEnchantmentOnRefreshEvent>(EncModifyResistance_Apply);
            ...
            SubscribeComponent<EncModifySkillComponent, ApplyEnchantmentOnRefreshEvent>(EncModifySkill_Apply);
        ...
        private void EncModifyAttribute_Apply(EntityUid uid, EncModifyAttributeComponent component, ref ApplyEnchantmentOnRefreshEvent args)
        {
        ...
        private void EncModifySkill_Apply(EntityUid uid, EncModifySkillComponent component, ref ApplyEnchantmentOnRefreshEvent args)
        {
            if (_skills.TryGetKnown(args.Equipper, component.SkillID, out var skill))
            {
                skill.Level.Buffed += args.AdjustedPower;
