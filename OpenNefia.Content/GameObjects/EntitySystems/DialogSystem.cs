...
namespace OpenNefia.Content.GameObjects.EntitySystems
{
    ...
    public class DialogChoice
    {
        ...
        public PrototypeId<DialogNodePrototype> Id { get; set; }

        public DialogChoice(int priority, PrototypeId<DialogNodePrototype> id)
        {
            Priority = priority;
            Id = id;
        }
    ...
    {
        public IDialogLayer Layer { get; set; } = default!;
