...
namespace OpenNefia.Content.UI.Layer.Repl
{
    ...
    /// 
    /// (From https://github.com/waf/PrettyPrompt/blob/main/src/PrettyPrompt/Panes/CompletionPane.cs)
    /// </summary>
    sealed class SlidingArrayWindow<T> : IReadOnlyCollection<T>
    {
        ...
        public SlidingArrayWindow(T[] array, int windowLength = 10, int selectedIndex = 0, int windowBuffer = 3)
        {
            ...
            windowStart = CalculateWindowStart(array, windowLength, selectedIndex);
