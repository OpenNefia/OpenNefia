...
namespace OpenNefia.Build.Tasks
{
    ...
    1) dotnet ./OpenNefia.XamlInjectors.dll <ReferencesOutputPath>
       , where <ReferencesOutputPath> likes {referencesOutputPath}
    2) dotnet ./OpenNefia.XamlInjectors.dll <AssemblyFilePath> <ReferencesFilePath> <OutputPath>
       , where:
           ...
           - <OutputPath> likes {referencesOutputPath}/{OutDll}");
            ...
            return new CompileOpenNefiaXamlTask()
            {
                AssemblyFile = args[0],
